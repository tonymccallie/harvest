...
var HomePage = (function () {
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        ...
        this.greybackProvider.getCalendars().subscribe(function (results) {
            console.log(results);
        }, function (msg) { return console.error("ErrorFOO: " + msg.status + " " + msg.statusText); });
    };
